...
-- 12. Table: pengumuman (Lecturer announcements shown as student notifications)
...
(10, '25211002', 'Ahmad822', 'Ahmad Pratama', 'ahmad.pratama.25211002@mhs.unas.ac.id', 'mahasiswa', 'aktif'),
...
-- Seed 9: Announcements (Pengumuman Dosen)
INSERT IGNORE INTO pengumuman (id, dosen_id, kelas_id, judul, isi, tanggal) VALUES
(1, 1, 1, 'Perubahan Jadwal Praktikum', 'Praktikum minggu ini berpindah ke Ruang Lab Komputer 2.', CURDATE()),
(2, 1, NULL, 'Materi Pertemuan 2 Sudah Tersedia', 'Slide pertemuan 2 sudah dapat diunduh melalui menu Kelas > Materi.', CURDATE());
