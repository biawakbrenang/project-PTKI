...
<head>
  ...
  <title>Pengumuman - E-Learning Akademik</title>
...
<body>
  ...
  <main>
    <div class="page-header">
      ...
      <p class="page-subtitle">Kirim informasi penting untuk kelas dan mahasiswa Anda.</p>
    </div>

    <div class="card">
      <div class="card-header">
        <h2 class="card-title">Pengumuman Kelas</h2>
      </div>
      <div class="card-body">
        <p class="text-muted">Fitur Pengumuman sedang dalam pengembangan.</p>
