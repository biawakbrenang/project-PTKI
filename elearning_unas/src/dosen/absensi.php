...
<head>
  ...
  <title>Input Absensi - E-Learning Akademik</title>
...
<body>
  ...
  <main>
    <div class="page-header">
      ...
      <p class="page-subtitle">Catat dan pantau kehadiran mahasiswa per pertemuan.</p>
    </div>

    <div class="card">
      <div class="card-header">
        <h2 class="card-title">Absensi Kelas</h2>
      </div>
      <div class="card-body">
        <p class="text-muted">Fitur Input Absensi sedang dalam pengembangan.</p>
