...
<body>
  ...
  <main>
    <div class="page-header">
      ...
      <p class="page-subtitle">Kelola kelas, jadwal pembelajaran, dan kapasitas peserta.</p>
    </div>

    <div class="card">
      <div class="card-header">
        <h2 class="card-title">Manajemen Kelas</h2>
      </div>
      <div class="card-body">
        <p class="text-muted">Fitur Kelola Kelas sedang dalam pengembangan.</p>
