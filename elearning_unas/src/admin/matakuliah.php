...
<head>
  ...
  <title>Kelola Matakuliah - E-Learning Akademik</title>
...
<body>
  ...
  <main>
    <div class="page-header">
      <h1 class="page-title">Kelola Matakuliah</h1>
      <p class="page-subtitle">Kelola daftar matakuliah dan kurikulum akademik.</p>
    </div>

    <div class="card">
      <div class="card-header">
        <h2 class="card-title">Manajemen Matakuliah</h2>
      </div>
      <div class="card-body">
        <p class="text-muted">Fitur Kelola Matakuliah sedang dalam pengembangan.</p>
