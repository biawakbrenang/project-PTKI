...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'add_materi') {
    ...
    $file_name = sanitizeInput($_POST['file_name'] ?? 'Materi_Pertemuan.pdf');
    ...
    try {
        $stmtMateri = $pdo->prepare("
            ...
            VALUES (:pertemuan, :judul, :deskripsi, '/uploads/materi/slide.pdf', :file_name, 2048576, 'pdf')
        ");
        $stmtMateri->execute([
                        ...
                        <div>
                            ...
                            <form action="" method="POST" class="form-stack">
                                ...
                                <div class="two-col-grid-align-end">
                                    <div>
                                        <label class="form-label">Nama Berkas Fisik</label>
                                        <input type="text" name="file_name" required value="modul_pembelajaran_si.pdf" class="form-input font-mono">
                                    </div>
                                    <div>
