...
if (!isset($_SESSION['absensi_token'])) {
    $_SESSION['absensi_token'] = rand(100000, 999999);
}
$current_token = $_SESSION['absensi_token'];
...
<head>
    ...
    <title>Sistem Presensi Mahasiswa - ECO-LEARNING</title>
    ...
    <div class="main-content">
        ...
        <main class="page-container">
            ...
            <div class="page-header">
                <div>
                    <h1 class="page-title">Sistem QR & Presensi Token</h1>
                    <p class="page-subtitle">Gunakan token 6-digit dinamis atau rekam presensi mahasiswa secara manual.</p>
                </div>
            </div>
            ...
            <div class="split-grid">
                ...
                <div class="card space-y-6">
                    ...
                    <!-- 6 Digit Token Generator Panel -->
                    <div class="token-panel">
                        <span class="token-label">Token Presensi Mahasiswa</span>
                        ...
                        <p class="token-desc">
                            Minta mahasiswa memasukkan kode di atas pada dasbor mereka. Berlaku sampai sesi berakhir.
                        </p>

                        <button onclick="window.location.reload()" class="btn-primary btn-block mt-5">
                            Perbarui Token Baru
                        </button>
                    </div>
                </div>
                                                ...
                                                <td class="table-cell">
                                                    ...
                                                    <div class="radio-attendance-group">
                                                        ...
                                                        <label class="radio-attendance-label label-danger">
                                                            <input type="radio" name="attendance[<?= $st['krs_id'] ?>]" value="alpa" class="radio-attendance-input">
                                                            <span>A</span>
                                                        </label>
                                                    </div>
                                                </td>
